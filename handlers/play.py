...
@Client.on_message(filters.command(["oynat","oynat@JesterMusicBot"]) 
                   & filters.group
                   & ~filters.edited 
                   & ~filters.forwarded
                   & ~filters.via_bot)
async def oynat(_, message: Message):
    ...
    lel = await message.reply("🔄 **işleniyor...**")
            ...
            if administrator == message.from_user.id:
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "**Müzik asistanı, müzik çalmak için bu gruba katıldı 🎵**")
    ...
    if audio:
        ...
        try:
            ...
            await lel.edit(
                "❌ Şarkı bulunamadı.\n\nBaşka bir şarkı deneyin veya doğru heceleyin."
            )
            print(str(e))
            return
